...
/***Configuracion de los pulsadores para simular entradas
	...
	GPIO_Init(&JoystickDerecha, ENTRADA, BAJO, GPIO__2_0 );
	...
	/* Configuro interrupcion de P2.2 */
	LPC_GPIOINT->IO2IntEnF |= 1 << 0; //Configuro solo que se ejecute la INT cuando en Falling edge
