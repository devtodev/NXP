...
src/%.o: ../src/%.c
	...
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=softfp -mfpu=fpv4-sp-d16 -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -D__CODE_RED -D__LPC43XX__ -D__REDLIB__ -D__USE_LPCOPEN -DCORE_M4 -DDEBUG -I"/home/carlos/ciaa-ide/workspace/lpcopen_lpc4337/inc" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
