 ...
 * @return 		None
 ***********************************************************************/
//XXX ALE!!! Lo deshice Static!!! Y le cambié el nombre para matchear lo que esperaba el driver de SD
...
void SSP_Init(LPC_SSP_TypeDef *SSPx, SSP_CFG_Type *SSP_ConfigStruct)
{
	...
	//XXX ALE!!!Le cambié el nombre para matchear lo que esperaba el driver de SD
...
/*****************************************************************************//**
* @brief		Set data size bit selected
* @param[in]	SSPx pointer to LPC_SSP_TypeDef structure, should be:
* 				- LPC_SSP0: SSP0 peripheral
* 				- LPC_SSP1: SSP1 peripheral
* @return		Data size, Should be:
*				- SSP_DATABIT_4: 4 bit transfer
*				- SSP_DATABIT_5: 5 bit transfer
*				...
*				- SSP_DATABIT_16: 16 bit transfer
*******************************************************************************/
uint8_t SSP_SetDataSize(LPC_SSP_TypeDef* SSPx, uint8_t dataSize)
{
	CHECK_PARAM(PARAM_SSPx(SSPx));
	return (SSPx->CR0 & (0xF));
}
